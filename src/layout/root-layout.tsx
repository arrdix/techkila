...
export function RootLayout() {
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="w-[1000px] h-[1500px] bg-gradient-to-r from-cyan-300 from-40% via-cyan-400 via-60% to-cyan-300 to-90% absolute bottom-[1250px] lg:bottom-[850px] left-0 -translate-x-[400px] rounded-full blur-[150px] -z-40" />
        </div>
    )
}
