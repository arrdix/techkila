    ...
    return (
        <div className="flex flex-col items-center gap-20 xl:gap-40 p-8 xl:p-32">
            <div className="flex flex-col items-center gap-4 w-full">
                ...
                <div className="flex flex-row justify-evenly gap-4 w-full xl:w-5/6">
            ...
            <div className="flex flex-col items-center gap-8 w-full sm:w-4/6">
                <h2 className="text-5xl leading-less sm:text-6xl md:text-7xl font-black text-center px-4 sm:px-0">
